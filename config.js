...
module.exports = {
	...
	// Translation options.
	textDomain: 'pwd', // Your textdomain here.
	translationFile: 'pwd.pot', // Name of the transalation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'DigiPress', // Package name.
	bugReport: 'https://www.digitalmonopoly.com.au/contact/', // Where can users report bugs.
	lastTranslator: 'Jon Mather <jon@digitalmonopoly.com.au>', // Last translator Email ID.
	team: 'Dev Team <dev@digitalmonopoly.com.au>', // Team's Email ID.
